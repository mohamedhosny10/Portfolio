      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <button
              onClick={copyEmail}
              className="relative flex flex-col items-center p-4 bg-white rounded-lg hover:shadow-md transition-shadow"
            >
              ...
              {copied && (
                <span className="absolute -bottom-2 translate-y-full text-xs bg-purple-600 text-white px-2 py-1 rounded">
                  Copied!
                </span>
              )}
            </button>
            <div className="flex flex-col items-center p-4 bg-white rounded-lg hover:shadow-md transition-shadow">
              ...
              <div className="flex flex-col items-center gap-1 mt-1">
                <a
                  ...
                  className="text-sm font-semibold text-slate-900 hover:text-purple-600 transition-colors flex items-center gap-1"
                >
                  <span className="text-xs font-medium text-purple-600 bg-purple-50 px-1.5 py-0.5 rounded border border-purple-200">
                    UAE
                  </span>
                  {personalInfo.phoneUAE}
                </a>
                <a
                  href={`tel:${personalInfo.phoneEgypt || personalInfo.phone}`}
                  className="text-sm font-semibold text-slate-900 hover:text-purple-600 transition-colors flex items-center gap-1"
                >
                  <span className="text-xs font-medium text-slate-600 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200">
                    EG
                  </span>
                  {personalInfo.phoneEgypt || personalInfo.phone}
                </a>
              </div>
            </div>
            <a
